                ...
                <div class="ecommerce-widget">
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header">Daftar Pelajaran</h5>
                                            ...
                                            if ($cek > 0) {
                                                while ($data = mysqli_fetch_array($query)) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $data['nama_pelajaran'] ?></td>
                                                        <td class="text-center">
                                                            <div class="input-group-append be-addon">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a href="form-pelajaran.php?id=<?php echo $data['id_pelajaran'] ?>&action=edit&data=galeri"
                                                                       class="dropdown-item">Edit</a>
                                                                    <a href="proses/pelajaran.php?id=<?php echo $data['id_pelajaran'] ?>&action=delete"
